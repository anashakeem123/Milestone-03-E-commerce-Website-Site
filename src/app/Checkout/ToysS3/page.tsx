...
export default function Flash() {
    const product = {
        ...
        about: [
          "🏓 **Ideal for Indoor & Outdoor Play**: This versatile practice pad with a wooden stick is perfect for both indoor and outdoor play, offering kids the opportunity to practice their skills anytime, anywhere.",
          ...
          "🏓 **Perfect Gift Idea for Kids**: This pad and wooden stick set makes a wonderful gift for children who enjoy sports and want to improve their athletic abilities, providing both fun and skill-building in one package.",
        ],
        Price:"$0.54",
