...
export default function Flash() {
  const product = {
    ...
    about: [
      "🎂❤️Gesture Control Mode: Allows you to order the camera to take a photo or record a video by just doing relative hand gesture.",
      "🎂❤️Functions: Sideward flight, turn left/right, up/down, forward/backward, obstacle avoidance, 4K, one key take off/landing/return, 3D flip, trajectory flight, headless mode, gesture control.",
      "🎂❤️Trajectory flight: With this function, draw a trajectory on the screen, the aircraft will fly according to this trajectory.",
